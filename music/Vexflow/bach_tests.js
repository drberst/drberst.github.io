...
function minuet1(options) {
    ...
    system.addStave({
        voices: [
            score.set({ clef: "bass" }).voice([notes('D4/q[id="m8a"]'), beam(notes('D3/8, C4, B3[id="m8b"], A3', { stem: "down" }))].reduce(concat)),
        ],
    });
    system.addConnector("singleRight");
    ...
    system
        .addStave({
            voices: [
                score.set({ clef: "treble" }).voice([notes('c5/q[id="m13a"]'), beam(notes("d5/8, c5, b4, a4", { stem: "down" }))].reduce(concat)),
            ],
        })
        .addClef("treble")
        .addKeySignature("G");
    ...
    system
        .addStave({
            voices: [
                score.set({ clef: "treble" }).voice([notes('b5/q[id="m17a"]'), beam(notes("g5/8, a5, b5, g5", { stem: "down" }))].reduce(concat)),
